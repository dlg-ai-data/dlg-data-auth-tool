...
(function (root, factory) {
    ...
    var requestAnimFrame = window.requestAnimationFrame ||
        ...
        Circles = function (options) {
            ...
            this._colors = options.colors || ['#EEE', '#6ab04c'];
            this._svg = null;
    ...
    Circles.prototype = {
        ...
        _generate: function () {
            ...
            this._el.innerHTML = '';
            this._el.append(this._wrapContainer);
        ...
        _generateWrapper: function () {
            ...
            this._wrapContainer.append(this._svg);
            this._wrapContainer.append(this._textContainer);
