        ...
        resetSubmenuProps: function(e) {
            ...
            if ( submenus ) {
                for (var i = 0, len = submenus.length; i < len; i++) {
                    ...
                    $("#logout_btn").css('overflow', '');
                    $("#admin-info-section").css('display', '')
                    $("#admin-info-section").css('overflow', '')
...
var KTLayoutAsideToggle = function() {
	...
	var _init = function() {
		...
		_toggleObject.on('toggle', function(toggle) {
			...
			$("#admin-info-section").css("display","none");
		});
		...
		_toggleObject.on('afterToggle', function(toggle) {
			if (KTUtil.hasClass(_body, 'aside-minimize') === false && KTUtil.hasClass(_body, 'aside-minimize-hoverable')) {
                $("#logout_btn").css("display","block");
			$("#admin-info-section").css("display","flex");
            }
		});
	}
